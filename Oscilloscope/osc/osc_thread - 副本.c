...
static unsigned short dac_bb[4] = { 1870,2000,270,20};
static unsigned short lsd_dac[4] = { 1870,2000,270,20};
/* gui task */
static void osc_thread(void)
{
	if( dac_bb[0] !=  lsd_dac[0] || dac_bb[1] !=  lsd_dac[1] || dac_bb[2] !=  lsd_dac[2] || dac_bb[3] !=  lsd_dac[3] )
	{
		lsd_dac[0] = dac_bb[0];
		lsd_dac[1] = dac_bb[1];
		lsd_dac[2] = dac_bb[2];
		...
		osc_voltage_output(dac_bb[0],dac_bb[1],dac_bb[2],dac_bb[3]);
